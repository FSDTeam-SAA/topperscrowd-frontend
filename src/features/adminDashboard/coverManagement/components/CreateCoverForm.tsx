...
import { useCreateCover } from "../hooks/useCoverManagement";
import {
  BookOpen,
  AlignLeft,
  Image as ImageIcon,
...
export default function CreateCoverForm({
  onSuccessAction,
}: {
  onSuccessAction?: () => void;
}) {
  const { mutate: create, isPending } = useCreateCover();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    create(submitData, {
      onSuccess: (data) => {
        toast.success(data.message || "Cover created successfully!");
        setFormData({
          title: "",
          description: "",
          edition: "",
      ...
      onError: (error: unknown) => {
        ...
        toast.error(err?.response?.data?.message || "Failed to create cover");
      },
    });
  };
    ...
    <div className="w-full">
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div className="p-8 border-b border-slate-100 bg-slate-50/50">
          <h2 className="text-2xl font-bold text-slate-900">Create Cover</h2>
          <p className="text-slate-500 mt-1">
            Fill in the details below to add a new book cover to the home page
            hero section.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                required
                placeholder="e.g. King Of Curses"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                required
                rows={3}
                placeholder="Describe the cover book..."
